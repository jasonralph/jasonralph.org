				...
				<table class="flag-form-table">
					<tr valign="top">
						<td style="width: 216px;">
							...
							<p>
								<label><input type="checkbox" name="thumbFix" id="thumbFix" value="1" <?php checked( '1', $flag->options['thumbFix'] ); ?> /> <?php _e( 'Ignore the aspect ratio, no portrait thumbnails', 'flash-album-gallery' ); ?>
								</label></p>
