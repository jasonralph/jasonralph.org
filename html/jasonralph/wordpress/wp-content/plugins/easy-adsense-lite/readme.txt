...
The bootstrap/AJAX version of the plugin is still available as the [Pro version](http://buy.thulasidas.com/easy-adsense "Pro version of the Easy Plugin for AdSense plugin").
