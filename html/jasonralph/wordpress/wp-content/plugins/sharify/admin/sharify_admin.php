...
function admin_init_sharify() {
	...
	register_setting('sharify', 'display_button_skype');
	...
	register_setting('sharify', 'sharify_skype_btn_size');
	...
	register_setting('sharify', 'sharify_cpm_skype');
	register_setting('sharify', 'sharify_cph_skype');
